...
return <header className="hero" id="top">
  ...
  <aside className="hero-aside"><div className="portrait-frame"><div className="portrait-label">Based in India · building worldwide</div><img src={imageURL.href} alt="Amrit Bhardwaj"/><div className="portrait-stamp">BUILD<br/>SHIP<br/>LEARN</div></div><div className="hero-meta"><div><strong>1726</strong><span>LeetCode max</span></div><div><strong>3+</strong><span>Production systems</span></div><div><strong>2027</strong><span>Graduating</span></div></div></aside></div>
